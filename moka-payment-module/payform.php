    ...
    <?php if ($error_message) { ?>
        <div class="row">
            <ul class="woocommerce-error" id="errDiv">
                <li>
                    <?php echo _('Payment Error:') ?> 
                    <b><?php echo $error_message; ?></b><br/>
                    <?php echo _('Please check the form and try again') ?>
                </li>
            </ul>
        </div>
    <?php } ?>
                        ...
                        <div class="hepsi">
                            ...
                            <div class="demo-container">
                                ...
                                <div class="form-group active moka">
                                    <form  novalidate autocomplete="on" method="POST"  action="" id="mokapostform">
...
<input value="<?php echo $orderid ?>" name="order_id" type="hidden">
	...
	<?php } ?>
                         ...
                         <?php } ?>
                            ...
                            <button type="submit" class="mokaode" style=""><span class="mokaOdemeTutar"><?php echo $showtotal;?></span><span class="mokaOdemeText"> ÖDE</span></button>
                            </form>
